module github.com/datachainlab/ibc-parlia-relay/relayer

go 1.19

require (
	github.com/datachainlab/ethereum-lcp v0.0.0
	github.com/datachainlab/ibc-parlia-relay v0.0.0
	github.com/datachainlab/lcp v0.1.3
...
replace (
	github.com/datachainlab/ethereum-lcp => ../../ethereum-lcp-poc
	github.com/datachainlab/ibc-parlia-relay => ../
